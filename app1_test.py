...
loggistic_classifier=joblib.load('/Users/yier.jin/Desktop/Conference_Abs_project/loggistic_classifier.pkl')

### upload csv files
standardize_text=pd.read_csv("/Users/yier.jin/Desktop/Conference_Abs_project/standardize_Abstract.csv")
